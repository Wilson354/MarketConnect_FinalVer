...
const products = [
  { id: 1, name: 'Producto 1', category: 'Categoría 1', price: `$${getRandomPrice()}`, description: 'Descripción del producto 1', image: productImage1 },
  { id: 2, name: 'Producto 2', category: 'Categoría 2', price: `$${getRandomPrice()}`, description: 'Descripción del producto 2', image: productImage2 },
  { id: 3, name: 'Producto 3', category: 'Categoría 3', price: `$${getRandomPrice()}`, description: 'Descripción del producto 3', image: productImage3 },
  { id: 4, name: 'Producto 4', category: 'Categoría 1', price: `$${getRandomPrice()}`, description: 'Descripción del producto 4', image: productImage4 },
  { id: 5, name: 'Producto 5', category: 'Categoría 2', price: `$${getRandomPrice()}`, description: 'Descripción del producto 5', image: productImage5 },
  { id: 6, name: 'Producto 6', category: 'Categoría 3', price: `$${getRandomPrice()}`, description: 'Descripción del producto 6', image: productImage6 },
  { id: 7, name: 'Producto 7', category: 'Categoría 1', price: `$${getRandomPrice()}`, description: 'Descripción del producto 7', image: productImage7 },
  { id: 8, name: 'Producto 8', category: 'Categoría 2', price: `$${getRandomPrice()}`, description: 'Descripción del producto 8', image: productImage8 },
  { id: 9, name: 'Producto 9', category: 'Categoría 3', price: `$${getRandomPrice()}`, description: 'Descripción del producto 9', image: productImage9 },
  { id: 10, name: 'Producto 10', category: 'Categoría 1', price: `$${getRandomPrice()}`, description: 'Descripción del producto 10', image: productImage10 },
  { id: 11, name: 'Producto 11', category: 'Categoría 2', price: `$${getRandomPrice()}`, description: 'Descripción del producto 11', image: productImage11 },
  { id: 12, name: 'Producto 12', category: 'Categoría 3', price: `$${getRandomPrice()}`, description: 'Descripción del producto 12', image: productImage12 },
  { id: 13, name: 'Producto 13', category: 'Categoría 1', price: `$${getRandomPrice()}`, description: 'Descripción del producto 13', image: productImage13 },
  { id: 14, name: 'Producto 14', category: 'Categoría 2', price: `$${getRandomPrice()}`, description: 'Descripción del producto 14', image: productImage14 },
  { id: 15, name: 'Producto 15', category: 'Categoría 3', price: `$${getRandomPrice()}`, description: 'Descripción del producto 15', image: productImage15 },
  { id: 16, name: 'Producto 16', category: 'Categoría 1', price: `$${getRandomPrice()}`, description: 'Descripción del producto 16', image: productImage16 },
  { id: 17, name: 'Producto 17', category: 'Categoría 2', price: `$${getRandomPrice()}`, description: 'Descripción del producto 17', image: productImage17 },
  { id: 18, name: 'Producto 18', category: 'Categoría 3', price: `$${getRandomPrice()}`, description: 'Descripción del producto 18', image: productImage18 },
  { id: 19, name: 'Producto 19', category: 'Categoría 1', price: `$${getRandomPrice()}`, description: 'Descripción del producto 19', image: productImage19 },
  { id: 20, name: 'Producto 20', category: 'Categoría 2', price: `$${getRandomPrice()}`, description: 'Descripción del producto 20', image: productImage20 },
];
